...
python -m pip config --site set global.extra-index-url https://PythonFeed:$PYTHON_FEED_PAT@pkgs.dev.azure.com/PrediktorDevOps/Development/_packaging/PythonFeed/pypi/simple/
