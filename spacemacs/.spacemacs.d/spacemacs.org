...
# #+end_src
 ...
 Have tried the two different options below to properly format the files below.
:NOTER_DOCUMENT: ${file}
:NOTER_DOCUMENT: %(orb-process-file-field \"${=key=}\")
...
** Keybindings
  ...
  #+BEGIN_SRC emacs-lisp :tangle spacemacs.el
    ...
    ;; (spacemacs/set-leader-keys "fen" (lambda () (interactive) (find-file "~/Insync/olavpe/BigArch.org")))
