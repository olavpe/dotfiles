...
#+BEGIN_SRC emacs-lisp :tangle spacemacs.el
  ...
  (with-eval-after-load 'org (setq
   org-agenda-files '("/home/olav/Insync/olavpe/org-agenda/life.org"
                      "/home/olav/Insync/olavpe/org-agenda/masters.org"
                      "/home/olav/Insync/olavpe/org-agenda/hobbies.org")
   ))
  ;; Org-Roam
  (setq
...
**** Masters General Project Templates
     ...
     *NB!* Therefore they must be stored using ~org-refile~.
...
#+BEGIN_SRC emacs-lisp :tangle spacemacs.el
  ...
  (file+olp+datetree "../org-agenda/masters.org")
   "* Meeting - %? \t :meeting: \n CREATED: %U")
...
#+BEGIN_SRC emacs-lisp :tangle spacemacs.el
  ...
  (file+olp+datetree "../org-agenda/skytrack.org")
   "* TODO %? \t%^g \n CREATED: %U")
...
#+BEGIN_SRC emacs-lisp :tangle spacemacs.el
  ...
  (file+olp+datetree "../org-agenda/thesis.org")
   "* TODO %? \t%^g \n CREATED: %U")
...
#+BEGIN_SRC emacs-lisp :tangle spacemacs.el
  ...
  (file+olp+datetree "../org-agenda/life.org")
   "* TODO %? \t%^g \n CREATED: %U")
...
#+BEGIN_SRC emacs-lisp :tangle spacemacs.el
  ...
  (file+olp+datetree "../org-agenda/hobbies.org")
   "* TODO %? \t%^g \n CREATED: %U")
  ("hri" "Create task with info" entry
  (fihe+olp+datetree "../org-agenda/hobbies.org")
   "* TODO %^{Task} \t%^g \n CREATED: %U \n %?")
...
#+BEGIN_SRC emacs-lisp :tangle spacemacs.el
  ...
  ;; No Date Prompts
  ("rf" "Food" entry
  (file+headline "../org-agenda/recommendations.org" "Food")
   "* TODO %^{Task} \t%^g \n CREATED: %U \n %?")
  ("rm" "Movies" entry
  (file+headline "../org-agenda/recommendations.org" "Movies")
   "* TODO %^{Task} \t%^g \n CREATED: %U \n %?")
  ("rb" "Books" entry
  (file+headline "../org-agenda/recommendations.org" "Books")
   "* TODO %^{Task} \t%^g \n CREATED: %U \n %?")
  ("rs" "Shows" entry
  (file+headline "../org-agenda/recommendations.org" "Shows")
   "* TODO %^{Task} \t%^g \n CREATED: %U \n %?")
#+END_SRC
